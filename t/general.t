...
EOC
my $ref = XMLin($xml); #This is an XML::Simple class
...
EOC
$ref = XMLin($xml); #This is an XML::Simple class
...
EOC
$ref = XMLin($xml);
my $bs = Algorithm::Evolutionary::Individual::Base->fromParam( $ref->{param}  );
...
#test 29
ok( $bs->asString()  ne $im->apply( $bs )->asString(), 1);
